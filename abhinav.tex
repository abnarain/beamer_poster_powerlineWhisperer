...
\innerblock{Threat Model} {
  ...
  \blocknode{System Design }% 
  {
    ...
    \innerblock{Transmitter Block Chain} { 
    ...
    \innerblock{Reciever Block Chain}{ 
  ...
  { 
    \innerblock{}{
      PowerlineWhisperer is built from coupler and software design radio is used for transmission of the message, as shown below 
    \begin{center}
