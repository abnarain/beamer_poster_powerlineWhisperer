...
\innerblock{Threat Model} {
  ...
  { 
    ...
    \includegraphics[scale=0.45]{figures/ncurve_53_1_05_iq.pdf}
      \captionof{figure}{
          The three subplots show normalized histograms of the amplitude of
          quadrature samples taken from the powerline channel at a frequency of 2 MHz and 100 KHz bandwidth. Channel profile a) In
          ...
          pulses. The figure demostrate the channel conditions in extreme instances and the fact that the covert communication will resembles
          noise profile
          }
    \end{center}
    \begin{center}
